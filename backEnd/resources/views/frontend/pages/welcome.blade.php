          ...
          <nav class="navbar navbar-expand-lg navbar-custom">
            ...
            <a class="navbar-brand d-flex align-items-center">
              <img
                ...
                width="42"
                height="50" />
              <span style="font-weight: bold; opacity: 60%; font-size: 16px">Stuntless</span>
            </a>
    ...
    <div id="carouselExample" class="carousel slide">
      ...
      <button
        ...
        <span
          ...
          aria-hidden="true"
          style="background-color: #ec7fa9"></span>
      ...
      <div
        ...
        <div class="card-body">
          ...
          <a
            ...
            style="background-color: #87cefa">Lihat Lebih Lanjut</a>
        </div>
      </div>
      <!-- card beda -->
        ...
        <div class="d-flex mb-3" style="gap: 10px">
          <div
            ...
            <span
              ...
              class="align-items-center">+62 896 1241 4093</span>
          </div>
          <div
      ...
      <div class="carousel-inner">
        ...
        <div class="carousel-item active">
          <div class="d-flex justify-content-center">
            <div class="card" style="width: 50%; height: 150px;">
              <div class="card-body">
        ...
        <div class="d-flex flex-column">
          <div
            ...
            <img
              ...
              alt="" />
            <span style="font-size: clamp(12px, 2vw, 16px)">@Stuntless.Id</span>
          </div>
          <div
            class="align-items-center d-flex justify-content-center"
            style="gap: 10px">
            <img
              ...
              alt="" />
            <span style="font-size: clamp(12px, 2vw, 16px)">_Stuntless.Id</span>
          </div>
          <div
            class="align-items-center d-flex justify-content-center"
            style="gap: 10px">
